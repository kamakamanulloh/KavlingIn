...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public static final String TAG_pswd = "password";
    ...
    private String url = "http://kavlingin.site/log_in.php";
    ...
    public static String id, username, pswd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginFormView = findViewById(R.id.btnregister);
